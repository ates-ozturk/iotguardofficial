...
# -----------------------------------------------------------------------------
# Utility — Realtime scoring demo (tail features.csv)
#
# Purpose
#   - Minimal tailing scorer that prints decisions and writes an audit log.
#   - Intended for demos and sanity checks outside the full decision loop.
# -----------------------------------------------------------------------------
