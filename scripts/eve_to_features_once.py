...
# -----------------------------------------------------------------------------
# Utility — One-shot eve.json → features.csv converter
#
# Purpose
#   - Process an existing eve.json file and emit a features.csv with uniform
#     windowing (no tailing). Useful for offline PCAP->eve workflows.
# -----------------------------------------------------------------------------
